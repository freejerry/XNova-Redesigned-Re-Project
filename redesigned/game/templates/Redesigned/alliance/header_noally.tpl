...
<div id="inhalt">
	...
	<div id="tabs">
		...
		<ul class="tabsbelow" id="tab-ally">
			<li class=""><a href="#" onclick="loadpage('./?page=network&mode=create','{Alliance}','network');" title="{create_ally}"><span>{create_ally}</span></a></li>
			<li class=""><a href="#" onclick="{onclick2}" title="{search_ally}"><span>{search_ally}</span></a></li>
		</ul>
	</div>
