...
<div id="login">
<div id="login_input">
<form name="formular" action="" method="post" onsubmit="this.action='../uni'+document.getElementsByName('uni')[0].value+'/login.php'" >
<table width="400" border="0" cellpadding="0" cellspacing="0">
<tbody>
<tr style="vertical-align: top;">
	<td style="padding-right: 4px;">
		<select name="uni">
			<option value="1a">Universe 1</option>
			<option value="1a">Universe 2</option>
		</select>
