...
//Now give commander
doquery("UPDATE {{table}} SET `off_command_exp` = '".(time() + (60 * 60 * 24 * 7))."' WHERE `id` = '".$user['id']."' ;",'users');

?>
There is now a moon in orbit around your homeworld and you have commander for free for 1 week.
