...
*/
	...
	401 => array ('shield' => 20),
        ...
        409 => array ('shield' => 20000000),
        410 => array ('shield' => 100000000)
    );
	...
	401 => ($InfoAdversaire['misil_launcher']),
        ...
        407 => ($InfoAdversaire['sm_grav_dome']),
        408 => ($InfoAdversaire['xl_grav_dome'])
	);
    ...
    $SqlDefenseur .= "`sm_grav_dome`='".$DefenseAdversaire[409]."', ";
    $SqlDefenseur .= "`xl_grav_dome`='".$DefenseAdversaire[410]."' ";
