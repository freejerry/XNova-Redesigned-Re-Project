...
function InsertBuildListScript ( $CallProgram ) {
	...
	$BuildListScript .= "	var n           = new Date();\n";
	$BuildListScript .= "	var ss          = pp;\n";
	$BuildListScript .= "	var aa          = Math.round( (n.getTime() - v.getTime() ) / 1000. );\n";
	$BuildListScript .= "	var s           = ss - aa;\n";
	$BuildListScript .= "	var m           = 0;\n";
	$BuildListScript .= "	var h           = 0;\n\n";
